 ...
 *
 * Copyright 2007-2011, Michael J. I. Jackson
...
(function (au, k) {
    ...
    Q.getPlayer = function (aG) {
        ...
        if (S) {
            ...
            if (Q.flv && Q.f4v.ext.indexOf(S) > -1) {
                return "f4v"
            }
        ...
        for (var aJ = 0; aJ < Q.gallery.length; ++aJ) {
            ...
            if (aO) {
                ...
                if (aK.player == "inline") {
                    ...
                    if (aK.player == "swf" || aK.player == "flv" || aK.player == "f4v") {
    ...
    Q.iframe.prototype = {
        append: function (K, aG) {
            var S = '<iframe id="' + this.id + '" name="' + this.id + '" height="100%" width="100%" frameborder="0" marginwidth="0" marginheight="0" style="visibility:hidden" scrolling="no" onload="this.style.visibility=\'visible\'"';
            if (Q.isIE) {
    ...
    // <div id="sb-top"><div id="sb-top-close"><a id="sb-nav-close" title="{close}" onclick="Shadowbox.close()"></a></div></div>

    T.markup = '<div id="sb-container"><div id="sb-overlay"></div><div id="sb-wrapper"><div id="sb-title"><div id="sb-top"><div id="sb-top-close"><a id="sb-nav-close" title="{close}" onclick="Shadowbox.close()"></a></div></div><div id="sb-title-inner"></div></div><div id="sb-wrapper-inner"><div id="sb-body"><div id="sb-body-inner"></div><div id="sb-loading"><div id="sb-loading-inner"><span>{loading}</span></div></div></div></div><div id="sb-info"><div id="sb-info-inner"><div id="sb-counter"></div><div id="sb-nav"><a id="sb-nav-next" title="{next}" onclick="Shadowbox.next()"></a><a id="sb-nav-play" title="{play}" onclick="Shadowbox.play()"></a><a id="sb-nav-pause" title="{pause}" onclick="Shadowbox.pause()"></a><a id="sb-nav-previous" title="{previous}" onclick="Shadowbox.previous()"></a></div><div id="sb-caption"></div></div></div></div></div>';
    T.options = {
        animSequence: "sync",
        counterLimit: 10,
        counterType: "default",
